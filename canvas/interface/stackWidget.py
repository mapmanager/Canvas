...
class stackWidget(QtWidgets.QMainWindow):
    ...
    """
    def __init__(self, path : str = None, myStack : canvas.canvasStack = None):
        """
        Args:
            path: path to file
        ...
        if myStack is not None:
            ...
            self.myStack = canvas.canvasStack(path)
        else:
...
class myPyQtGraphPlotWidget(pg.PlotWidget):
    ...
    def __init__(self, myStack : canvas.canvasStack,
                    contrastDict : dict,
                    colorLutDict : dict,
                    parent=None):
        super().__init__(parent)
...
if __name__ == '__main__':
    ...
    try:
        ...
        myStack = canvas.canvasStack(path=path)
